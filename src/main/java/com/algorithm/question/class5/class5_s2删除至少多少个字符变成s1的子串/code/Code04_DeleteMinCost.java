package com.algorithm.question.class5.class5_s2删除至少多少个字符变成s1的子串.code;
...
public class Code04_DeleteMinCost {
    ...
    public static void main(String[] args) {
        ...
        Solution2UseDp solution2UseDp = new Solution2UseDp();
        for (int i = 0; i < testTime; i++) {
            String str1 = generateRandomString(str1Len, v);
            String str2 = generateRandomString(str2Len, v);
            int ans1 = solution2UseDp.minCostToSubSeq(str1, str2);
            int ans2 = solution2.minCostToSubSeq(str1, str2);

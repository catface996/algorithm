...
public class PrintTreeNodeUtil {
     ...
     * @return 节点个数
     */
    private static int getNodeNum(TreeNode x) {
        if (x == null) {
            return 0;
        }
     ...
     * @param layers 层数
     */
    public static void dfs(TreeNode root, int num, int layers, Map<Integer, Integer> leftMap,
     ...
     * @return 叶子节点数量
     */
    private static int getTerminalNodeNum(TreeNode x) {
        if (x == null) {
            return 0;
        }
     ...
     * @return true:是搜索二叉树;false:不是搜索二叉树
     */
    private static BstInfo processIsBst(TreeNode x) {
     ...
     */
    private static boolean isBt(TreeNode root) {
     ...
     */
    private static BtInfo processIsBt(TreeNode x) {
        if (x == null) {

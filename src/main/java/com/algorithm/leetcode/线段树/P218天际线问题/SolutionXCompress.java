package com.algorithm.leetcode.线段树.P218天际线问题;
...
@Slf4j
public class SolutionXCompress {

    // 10:24 下午	info
    //					解答成功:
    //					执行耗时:28 ms,击败了59.92% 的Java用户
    //					内存消耗:41.7 MB,击败了65.11% 的Java用户
    ...
    public List<List<Integer>> getSkyline(int[][] buildings) {
        ...
        for (int[] building : buildings) {
            ...
            int end = building[1];
            segmentTree.update(xMap.get(start), xMap.get(end), building[2]);
        }
    ...
    public static class TestClass {
        ...
        public void test1() {
            ...
            SolutionXCompress solution = new SolutionXCompress();
